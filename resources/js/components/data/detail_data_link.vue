...
<main class="main">
        <!-- Breadcrumb-->
            ...
            <li class="breadcrumb-item"><b>{{ per.nama_lengkap }}</b> / <b>{{ per.kd_saham }}</b></li>
            <!-- Breadcrumb Menu-->
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                ...
                                <form @submit.prevent="statusModal ? updateData() : saveData()">
                                    ...
                                    <div class="form-group">
                                        <label for="recipient-name" class="col-form-label">nama url :</label>
                                        
                                        <input type="text" class="form-control" v-model="form.nama_url" :class="{ 'is-invalid' : form.errors.has('Name_sub') }">
                                        <has-error :form="form" field="Name_sub"></has-error>                              
                                    </div>
                                    <div class="form-group">
                                        <label for="recipient-name" class="col-form-label">url :</label>
                                        
                                        <input type="text" class="form-control" v-model="form.url" :class="{ 'is-invalid' : form.errors.has('Name_sub') }">
                                        <has-error :form="form" field="Name_sub"></has-error>                              
                                    </div>
...
export default {
      ...
      methods:{
          ...
          loadData(){
              ...
              axios
              .get('/api/getDataLink/' + this.$route.params.id)
              .then(response =>{
          ...
          updateData(){
             ...
             this.loading = true;
             this.disabled = true;
             this.form.put('/api/update_link/' + this.form.id)
             .then(() => {
           ...
           deleteData(id){
            Swal.fire({
              ...
              .then(result => {
                  if(result.value){
                    this.form.delete('/api/delete_link/' + id)
                    .then(()=>{
                      Swal.fire(
                        "Terhapus",
