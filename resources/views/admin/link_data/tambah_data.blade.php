              ...
              <div class="col-md-10">
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <form class="form-horizontal" action="{{ route('store_link') }}" method="post" >
                      ...
                      <div class="form-group row">
                        ...
                        <div class="form-group col-sm-2">
                          <select class="form-control" name="kd_saham">
                            ...
                            <option value="{{ $p->id }}" {{$p->id == $link->id ? "selected" : null}}>{{$p->kd_saham}}</option>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-4">
                        <input class="form-control @error('nama_url') is-invalid @enderror" type="text" name="nama_url" placeholder="keterangan url" value="{{old('nama_url')}}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                          ...
                          <input class="form-control @error('url') is-invalid @enderror" type="text" name="url" placeholder="Url" value="{{old('url')}}">
