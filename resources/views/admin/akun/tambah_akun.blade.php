...
<div class="row">
              <div class="col-md-10">
                <div class="card">
                  ...
                  <div class="card-body">
                    <form class="form-horizontal" action="{{route('store_akun')}}" method="post" >
                     @csrf
                        <div class="form-group row">
                          <label class="col-md-2 col-form-label" for="text-input">Nama lengkap</label>
                          <div class="col-md-9">
                            <input  class="form-control @error('nama') is-invalid @enderror" type="text" name="nama" placeholder="Nama lengkap" autocomplete="nama" value="{{ old('nama') }}" autofocus>
                                @error('nama')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                              <input  class="form-control @error('username') is-invalid @enderror" type="text" name="username" placeholder="Username" autocomplete="username" value="{{ old('username') }}" autofocus>
                                  @error('username')
                                      <span class="invalid-feedback" role="alert">
                                          <strong>{{ $message }}</strong>
                                      </span>
