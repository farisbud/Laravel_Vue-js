              ...
              <div class="col-md-10">
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <form class="form-horizontal" action="/admin/sub-kategori/{{$c->id}}" method="post" >
                        @method('patch')
                      @csrf
                      ...
                      <div class="form-group row">
                        ...
                        <div class="form-group col-sm-4">
                          <select class="form-control" name="category_id">
                            ...
                            {{-- <option value="{{$suc->id}}">{{$suc->category->Name_cat}}</option>  --}}
                            @foreach ($cat as $cat)
                                 
                            <option value="{{ $cat->id }}" {{$cat->id == $c->category_id ? "selected" : null}}>{{$cat->Name_cat}}</option>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-4">
                    <input class="form-control @error('Nama_sub') is-invalid @enderror" type="text" name="Nama_sub"  value="{{$c->Name_sub}}"> 
