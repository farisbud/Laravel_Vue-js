              ...
              <div class="col-md-10">
                <div class="card">
                  <div class="card-header">
                    ...
                    <strong>Edit Data Excel</strong>
                    
                    </div>
                  
                  <div class="card-body">
                    
                    <form class="form-horizontal" action="/admin/data-excel/{{ $excel->id }}" method="post">
                    @method('patch')
                      @csrf
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-4">
                        <input class="form-control @error('judul') is-invalid @enderror" type="text" name="judul" placeholder="Judul" value="{{old('judul',$excel->judul)}}">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-4">
                        <input class="form-control @error('excel') is-invalid @enderror" type="text" name="excel" placeholder="link excel" value="{{old('excel',$excel->url_excel)}}">
