              ...
              <div class="col-md-10">
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <form class="form-horizontal" action="{{ route('store_aboutUs') }}" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                          <input id="visi" value="{{old('visi')}}" type="hidden" name="visi">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-4">
                        <input id="misi" value="{{old('misi')}}" type="hidden" name="misi">
               ...
               <h3>Profile</h3>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-4">
                        <input class="form-control @error('telp') is-invalid @enderror" type="text" name="telp" placeholder="Telepon" value="{{old('telp')}}">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-md-5">
                      <textarea name="riwayat" class="form-control @error('riwayat') is-invalid @enderror" placeholder="riwayat" autocomplete="riwayat" cols="30" rows="10">{{ old('riwayat') }}</textarea>
                          @error('riwayat')
                              <span class="invalid-feedback" role="alert">
                                  <strong>{{ $message }}</strong>
                              </span>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-4">
                        <input class="form-control @error('pendidikan') is-invalid @enderror" type="text" name="pendidikan" placeholder="Pendidikan" value="{{old('pendidikan')}}">
